...
const NavBar = () => {
  ...
  return (
    ...
    >
      <button>
        <Navbar.Brand onClick={(e) => handleClick(e, 'get-started-section')}>
      ...
      <Navbar.Collapse id="responsive-navbar-nav">
        <Nav className="ml-auto">
          <button
            ...
            onClick={(e) => handleClick(e, 'account-section')}
          >
            Account
          </button>
          <button
          ...
          <button
            className="nav-heading"
            onClick={(e) => handleClick(e, 'income-section')}
          >
            Income
          </button>
          <button
            className="nav-heading"
            onClick={(e) => handleClick(e, 'rent-section')}
          >
            Rent
          </button>
          <button
            className="nav-heading"
            onClick={(e) => handleClick(e, 'food-section')}
          >
            Food
          </button>
          <button
            className="nav-heading"
            onClick={(e) => handleClick(e, 'expenses-section')}
          >
            Expenses
          </button>
          <button
